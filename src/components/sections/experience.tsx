...
export function Experience() {
  ...
  return (
    ...
    >
      <ol className='relative ml-3 border-l border-border pl-8 md:ml-6'>
        {t.experience.items.map((exp, i) => (
          <li key={exp.company} className='relative mb-10 last:mb-0'>
            <Reveal delay={i * 0.06}>
              <span className='absolute -left-10.5 top-1 grid size-7 place-items-center rounded-full border border-border bg-bg shadow-(--shadow-glow)'>
